...
class ContextMachine:
    ...
    async def move_to_next_scene(self, direction: Optional[str] = None) -> None:
        ...
        await self._machine.execute_next_transition(event, chat_id=chat_id, user_id=user_id,
    ...
    async def move_to_previous_scene(self) -> None:
        ...
        await self._machine.execute_back_transition(event, chat_id=chat_id, user_id=user_id)
    ...
    async def refresh_scene(self) -> None:
        ...
        await self._machine.refresh_current_scene(event, chat_id=chat_id, user_id=user_id)
